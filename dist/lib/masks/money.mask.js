...
var sanitized=this._sanitize(value,mergedSettings,oldValue);
...
var clearDelimiter=new RegExp('\\'+mergedSettings.delimiter,'g');
maskedValue=maskedValue.replace(clearDelimiter,'');
}
if(mergedSettings.separator){
var cleanSeparator=new RegExp('\\'+mergedSettings.separator,'g');
